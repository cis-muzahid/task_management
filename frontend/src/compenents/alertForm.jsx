...
const UpdateAlertModal = ({
  ...
  useEffect(() => {
    setAlertTime((prevAlertTime) => ({
      ...prevAlertTime,
      default_alert_time: localStorage.getItem("time_to_complete"),
    }));
  }, []);
  return (
    <Modal show={show} onHide={handleClose}>
      ...
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          ...
          <Button variant="primary" type="button" className="btn-sm mt-3 ml-2" onClick={handleClose}>
            Close
          </Button>
        </Form>
      </Modal.Body>
